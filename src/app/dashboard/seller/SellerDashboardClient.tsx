            ...
            <div className="section-shell py-8">
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-5 mb-8">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        <Link href="/sell/onboard" className="flex items-center gap-2 px-5 py-2.5 rounded-lg gradient-gold text-navy-950 font-bold text-sm shadow-lg">
                            ...
                            {listings.length > 0 ? (
                                <div className="divide-y divide-navy-100">
                                    {listings.map((listing) => {
                                        ...
                                        return (
                                            <div key={listing.id} className="px-6 py-4 flex items-center justify-between gap-4 hover:bg-navy-50/70 transition-colors">
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="flex flex-wrap items-center gap-4 text-xs text-navy-400">
                                                        ...
                                                        <span>{listing.asking_price ? formatCurrency(listing.asking_price) : 'Na upit'}</span>
                                ...
                                <div className="p-12 text-center">
                                    ...
                                    <Link href="/sell/onboard" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg gradient-accent text-white font-bold text-sm shadow-lg">
                                        <Plus className="w-4 h-4" />
                                        Kreiraj profil
                                    </Link>
                                </div>
                        ...
                        <div className="premium-card overflow-hidden">
                            ...
                            {ndas.length > 0 ? (
                                ...
                                <div className="p-8 text-center">
                                    ...
                                    <p className="text-sm text-navy-400 font-sans">Nema NDA zahtjeva.</p>
                                </div>
                            )}
                        </div>
                    </div>
